...
public class LoadUniMed {
	
	private static Logger log = Logger.getLogger(LoadUniMed.class);
	private ObjectStore os = null;
	private final static String resource = "xlsx/UniMed.xlsx";

	public static void main(String[] args) {
		new LoadUniMed().doExec();
	}
	...
	public void doExec() {
		...
		try {		
			...
			log.debug("Eliminando unimed existentes...");
			
			// delete previous objects
			Folder parentFolder = Factory.Folder.fetchInstance(os, "/UniMed", null);
			deleteRecursively(parentFolder, Boolean.FALSE);
			
			log.debug("Cargando unimed ...");
		    ...
		    for (Iterator<Row> rowIterator = sheet.iterator(); rowIterator.hasNext(); ) 
		    {
				...
				// Crea documento
				Document doc = Factory.Document.createInstance(os, "SolDocUniMed");
			...
			log.debug("Total de unimed cargados: " + processed);
