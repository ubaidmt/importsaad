define([
	...
	"dojo/text!./templates/SolDocBuscarUniMedDialog.html"
],
...
function(declare, 
	...
	/**
	 * @name importSaadPluginDojo.dialog.SolDocBuscarUniMedDialog
	 * @class Provides a dialog whose main content is an html page displayed in an iframe.  
	 * @augments ecm.widget.dialog.BaseDialog
	 */
	return declare("importSaadPluginDojo.dialog.SolDocBuscarUniMedDialog", [ BaseDialog ], {
	/** @lends importSaadPluginDojo.dialog.SolDocBuscarUniMedDialog.prototype */	
		...
		postCreate: function() {
			...
			this.setTitle("Búsqueda de Unidades y Medidas");
		...
		onSearch: function() {
			...
			html.set(this.message, "Consultando unidades y medidas ...");
			...
			var params = {};
			params.method = "searchSolDocUniMed";
			...
			Request.invokePluginService("ImportSaadPlugin", "SolDocService",
					{	
						...
						requestCompleteCallback: lang.hitch(this, function(response) {
							...
							if (results.length == 0) {
								domStyle.set(this.message, "color", "#000253");
								html.set(this.message, "No existen unidades y medidas con el criterio de consulta indicado");
								domStyle.set(this.progressBar, "display", "none");	
								return;
							}				
