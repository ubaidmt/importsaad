define([
	...
	/**
	 * @name importSaadPluginDojo.action.SolDocVersionarDialog
	 * @class
	 * @augments dijit.Dialog
	 */
	return declare("importSaadPluginDojo.action.SolDocVersionarDialog", [Dialog, _TemplatedMixin, _WidgetsInTemplateMixin], {
	/** @lends importSaadPluginDojo.action.SolDocVersionarDialog.prototype */
