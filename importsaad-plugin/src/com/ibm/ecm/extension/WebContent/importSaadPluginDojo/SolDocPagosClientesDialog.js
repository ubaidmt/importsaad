define([
	...
	/**
	 * @name importSaadPluginDojo.SolDocPagosClientesDialog
	 * @class
	 * @augments ecm.widget.dialog.BaseDialog
	 */
	return declare("importSaadPluginDojo.SolDocPagosClientesDialog", [BaseDialog], {
	/** @lends importSaadPluginDojo.SolDocPagosClientesDialog.prototype */
