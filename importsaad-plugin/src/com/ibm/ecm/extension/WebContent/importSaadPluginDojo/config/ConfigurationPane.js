define([
	...
	function(declare, lang, array, json, _TemplatedMixin, _WidgetsInTemplateMixin, ItemFileWriteStore, PluginConfigurationPane, template) {
		...
		/**
		 * @name importSaadPluginDojo.config.ConfigurationPane
		 * @augments ecm.widget.admin.PluginConfigurationPane
		 */
		return declare("importSaadPluginDojo.config.ConfigurationPane", [ PluginConfigurationPane, _TemplatedMixin, _WidgetsInTemplateMixin], {
		/** @lends importSaadPluginDojo.config.ConfigurationPane.prototype */
		...
		load: function(callback) {		
			...
			{		
				...
				array.forEach(items, lang.hitch(this, function(item) {		  				
					...
					else if (item.name == "pteiva")
						this.pteiva.setValue(item.value);					 
		...
		onSave: function() {
			...
			var configData = [
			    ...
			    {"name": "pteiva", "value": this.pteiva.getValue()},
