define([
	...
	/**
	 * @name importSaadPluginDojo.action.SolDocDevolucionesProvDialog
	 * @class
	 * @augments ecm.widget.dialog.BaseDialog
	 */
	return declare("importSaadPluginDojo.action.SolDocDevolucionesProvDialog", [BaseDialog], {
	/** @lends importSaadPluginDojo.action.SolDocDevolucionesProvDialog.prototype */
