define([
	...
	/**
	 * @name importSaadPluginDojo.SolDocDevolucionesCliDialog
	 * @class
	 * @augments ecm.widget.dialog.BaseDialog
	 */
	return declare("importSaadPluginDojo.SolDocDevolucionesCliDialog", [BaseDialog], {
	/** @lends importSaadPluginDojo.SolDocDevolucionesCliDialog.prototype */
