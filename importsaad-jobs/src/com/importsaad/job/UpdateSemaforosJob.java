...
public class UpdateSemaforosJob implements Job {

	private static Logger log = LoggerFactory.getLogger(UpdateSemaforosJob.class);
	...
	public void execute(JobExecutionContext context) throws JobExecutionException
    {
    	...
    	try {
	    	...
	    	// Job Implementation
        	UpdateSemaforosJobImpl impl = new UpdateSemaforosJobImpl();
	    	impl.setOsName(osName);
	    	impl.setAddDays(addDays);
	    	impl.doExec();
	    	Thread.sleep(1000); // timeout para reflejar progress bar en administrador
	    	context.setResult(JobExecutionDetail.RESULT_DONE + " (" + impl.getProcesados() + ")");
