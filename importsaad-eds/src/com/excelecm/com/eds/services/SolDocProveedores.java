...
public class SolDocProveedores {
	...
	public static JSONObject getData(String propertyName, JSONArray choices, Object initialValue, boolean isRequired) throws Exception {
		...
		try 
		{
	    	...
	    	jsonObj.put("displayName", "Proveedor");
        	...
        	result.put("customValidationError", "El Proveedor es obligatorio");
	...
	public static JSONArray getChoices(String osName) throws Exception {
		...
		try 
		{
			...
			String sql = "SELECT Id, FolderName FROM SolDocProveedor WITH EXCLUDESUBCLASSES WHERE This INFOLDER '/Proveedores'";
